...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Kid SHop Dashboard | Login</title>
      ...
      <link rel="stylesheet" href="{{asset('kidoldash/vendor/remixicon/fonts/remixicon.css')}}">  </head>
  <body class="">
    <!-- loader Start -->
    <div id="loading">
                     ...
                     <div class="p-0 card-body">
                        <div class="d-flex align-items-center auth-content">
                           ...
                           <div class="col-lg-5 content-right">
                            <img src="{{ asset('kidoldash/images/login/01.png') }}" class="img-fluid image-right" alt="">
