                            ...
                            <div class="row"> 
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        <label class="required" for="AdminName">Họ Và Tên</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="required" for="NumberPhone">Số Điện Thoại</label>
                                ...
                                <div class="col-md-12">                      
                                    <div class="form-group">
                                        <label class="required" for="AdminUser">Tên tài khoản</label>
                                ...
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        <label class="required" for="AdminPass">Mật Khẩu</label>
                                ...
                                <div class="col-md-6">                      
                                    <div class="form-group">
                                        <label class="required" for="AdminRePass">Xác Nhận Mật Khẩu</label>
